    ...
    <div className="w-full">
      ...
      <div className="hidden sm:grid lg:hidden grid-cols-3 gap-2">
        ...
        <div className="group bg-white border border-gray-600 rounded-md overflow-hidden flex hover:shadow-md transition-shadow duration-200">
          ...
          <div className="w-16 shrink-0 bg-white flex items-center justify-center ml-auto">
            <Box size={22} className="text-orange-500 group-hover:scale-110 transition-transform duration-200" strokeWidth={1.5} />
          </div>
        </div>
        ...
        <div className="group bg-white border border-gray-600 rounded-md overflow-hidden flex hover:shadow-md transition-shadow duration-200">
          ...
          <div className="w-16 shrink-0 bg-white flex items-center justify-center ml-auto">
            <Zap size={22} className="text-orange-500 group-hover:scale-110 transition-transform duration-200" strokeWidth={1.5} />
          </div>
        </div>
      </div>
      ...
      <div className="hidden lg:grid grid-cols-3 gap-3">
        <div className="group bg-white border border-gray-600 rounded-lg overflow-hidden flex hover:shadow-md transition-shadow duration-200">
          <div className="flex flex-col justify-center px-5 py-4">
            <p className="text-base font-regular text-slate-900">Accessories</p>
        ...
        <div className="group bg-white border border-gray-600 rounded-lg overflow-hidden flex hover:shadow-md transition-shadow duration-200">
          <div className="flex flex-col justify-center px-5 py-4">
            <p className="text-base font-regular text-slate-900">Fasteners</p>
            <p className="text-2xl font-medium text-slate-900 leading-none tabular-nums tracking-tighter mt-1">{fmt(s.fasCount)}</p>
          </div>
          <div className="w-20 shrink-0 bg-white flex items-center justify-center ml-auto">
            <Box size={30} className="text-orange-500 group-hover:scale-110 transition-transform duration-200" strokeWidth={1.5} />
          </div>
        </div>
        ...
        <div className="group bg-white border border-gray-600 rounded-lg overflow-hidden flex hover:shadow-md transition-shadow duration-200">
          <div className="flex flex-col justify-center px-5 py-4">
            ...
            <p className="text-2xl font-medium text-slate-900 leading-none tabular-nums tracking-tighter mt-1">{fmt(s.total)}</p>
          </div>
          <div className="w-20 shrink-0 bg-white flex items-center justify-center ml-auto">
            <Zap size={30} className="text-orange-500 group-hover:scale-110 transition-transform duration-200" strokeWidth={1.5} />
          </div>
        </div>
      </div>
