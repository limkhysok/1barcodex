  ...
  return (
    <div className="relative">
      <button
        ...
        className="flex items-center gap-2 h-8 px-3 text-[10px] font-black uppercase tracking-widest border border-gray-600 rounded-md bg-white text-slate-600 hover:border-orange-300 hover:text-orange-500 hover:bg-orange-50 transition-all cursor-pointer active:scale-95"
      >
    ...
    <div className="px-4 py-5 sm:px-5 sm:py-5 space-y-3">
      ...
      <div className={`grid grid-cols-1 lg:grid-cols-3 gap-5 mt-5 items-stretch transition-opacity duration-200 ${loading ? "opacity-50 pointer-events-none" : "opacity-100"}`}>
        <div className="lg:col-span-2 bg-white border border-gray-600 rounded-lg flex flex-col overflow-hidden min-w-0">
          ...
          <div className="w-full min-w-0 relative h-64 sm:h-80 md:h-96 lg:h-80 xl:h-96 p-4 pl-1">
